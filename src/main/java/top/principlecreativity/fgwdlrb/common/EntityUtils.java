...
import top.principlecreativity.fgwdlrb.api.IEntityManager;
import top.principlecreativity.fgwdlrb.api.WDLApi;
...
public class EntityUtils {
	...
	public static List<IEntityManager> getEntityManagers() {
		...
		for (WDLApi.ModInfo<IEntityManager> info : WDLApi.getImplementingExtensions(IEntityManager.class)) {
	...
	public static int getEntityTrackDistance(String mode, @Nonnull String type, @Nullable Entity entity) {
		if ("default".equals(mode)) {
			...
			String prop = WorldDownloader.worldProps.getProperty("Entity." +
	...
	public static boolean isEntityEnabled(@Nonnull String type) {
		boolean groupEnabled = WorldDownloader.worldProps.getProperty("EntityGroup." +
				getEntityGroup(type) + ".Enabled", "true").equals("true");
		boolean singleEnabled = WorldDownloader.worldProps.getProperty("Entity." +
	...
	public static String getTrackDistanceMode() {
		return WorldDownloader.worldProps.getProperty("Entity.TrackDistanceMode", "server");
	}
