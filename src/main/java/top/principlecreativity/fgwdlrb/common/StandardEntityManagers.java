...
public enum StandardEntityManagers implements IEntityManager {
	...
	public EntityUtils.SpigotEntityType getSpigotType(String identifier) {
		Class<? extends Entity> c = entityClassFor(identifier);
		if (c == null) {
			return EntityUtils.SpigotEntityType.UNKNOWN;
		}
		...
		if (EntityMob.class.isAssignableFrom(c) ||
			...
			return EntityUtils.SpigotEntityType.MISC;
		} else {
			return EntityUtils.SpigotEntityType.OTHER;
		}
	}
}
